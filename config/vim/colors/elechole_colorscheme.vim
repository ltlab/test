...
highlight Normal     ctermfg=250	ctermbg=Black guifg=lightgrey guibg=#000010
...
hi Comment        term=bold ctermfg=blue guifg=#6060ff
...
highlight StatusLine cterm=bold ctermfg=yellow	ctermbg=21 gui=bold guifg=yellow guibg=blue
highlight StatusLineNC	cterm=none ctermfg=yellow ctermbg=18 gui=none guifg=yellow guibg=darkblue
...
hi	cIdentifier		ctermfg=247 guifg=grey60
...
hi	Function		cterm=none ctermfg=214 guifg=#ff6600
"hi PreProc        term=underline ctermfg=blue guifg=#6060ff
hi PreProc        term=underline ctermfg=darkcyan guifg=#1ca4a4
hi PreCondit		ctermfg=cyan guifg=#00ffff
hi	cPPOperator		ctermfg=cyan guifg=#00ffff
...
hi	MyTagListFileName	cterm=none ctermfg=yellow ctermbg=18 gui=none guifg=yellow guibg=darkblue
...
hi	FoldColumn		ctermfg=cyan ctermbg=darkgrey guifg=cyan guibg=#606060
hi	TabLineFill		cterm=none ctermbg=235
hi	TabLine			cterm=none ctermfg=grey ctermbg=238
hi	TabLineSel		cterm=none ctermfg=yellow ctermbg=17
hi	VertSplit		cterm=none ctermfg=darkgrey ctermbg=darkgrey gui=none guifg=#606060 guibg=#606060
hi	Pmenu			ctermfg=brown ctermbg=234 guifg=#ac6600 guibg=#202020
hi	PmenuSel		ctermfg=yellow ctermbg=236 guifg=yellow guibg=#303030
hi	PmenuSbar		ctermbg=240 guibg=#505050
hi	PmenuThumb		cterm=none ctermbg=grey gui=none guibg=grey
